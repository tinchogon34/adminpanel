...
class ZonesControllerTest < ActionController::TestCase
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post :create, zone: { comment: @zone.comment, domain_id: @zone.domain_id, owner: @zone.owner, zone_templ_id: @zone.zone_templ_id }
    end
  ...
  test "should update zone" do
    patch :update, id: @zone, zone: { comment: @zone.comment, domain_id: @zone.domain_id, owner: @zone.owner, zone_templ_id: @zone.zone_templ_id }
    assert_redirected_to zone_path(assigns(:zone))
  end
